        ...
        <div>
          ...
          <AnimatePresence mode="wait">
            <Routes location={location} key={location.pathname}>
              ...
              />
              <Route path="/event" element={<TransitionEvent />} />
              <Route path="/news" element={<TransitionNews />} />
              <Route path="/news/:newsID" element={<TransitionNewsDetails />} />
              <Route
                path="/event/:eventId"
                element={<TransitionEventDetail />}
              />
              <Route path="/products" element={<TransitionProducts />} />
              <Route path="/contact" element={<TransitionContact />} />
