          ...
          <div className="timeLocation">
            ...
            <div className="eventRegister">
              <button>
                ...
                <img className="whiteArrow" src={whiteArrow} alt="img" />
              </button>
            </div>
          </div>
          <Link to="/event" className="eventGallery">
            <span>View Event Gallery</span>
            <img className="blackArrow" src={blackarrow} alt="img" />
          </Link>
        </div>
      ) : (
...
const TransitionEventDetail = () => {
  return <Transition OgComponent={<EventDetail />} />;
};

export default TransitionEventDetail;
